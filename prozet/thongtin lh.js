var emptyRow = "<tr><td colspan='6' class='text-center'> Không có bản ghi nào</td></tr>";
...
function loadDataFromLocal() {
  ...
  if (localData) {
    ...
    localArray.forEach(element => {
      ...
      dynamicTR = dynamicTR + "        <button class='btn btn-sm btn-success btn-edit'>Sửa </button>";
      dynamicTR = dynamicTR + "        <button class='btn btn-sm btn-danger btn-delete'> Xóa</button>";
